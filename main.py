...
# Render Environment se Base64 Cookies Restore logic
COOKIE_FILE_PATH = "cookies.txt"
cookies_b64 = os.getenv("YOUTUBE_COOKIES_BASE64")
if cookies_b64:
    try:
        with open(COOKIE_FILE_PATH, "wb") as f:
            f.write(base64.b64decode(cookies_b64.strip()))
        print(">> YouTube Cookies successfully restored from Render Environment!")
    except Exception as e:
        print(f">> Cookies restore error: {e}")
...
# --- YOUTUBE SEARCH PIPELINE (TV STREAMING) ---
...
# --- YOUTUBE AUDIO STREAM EXTRACTOR (TV STREAMING) ---
