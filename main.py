...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8636389576:AAGDv3vzvBmzlpfCRnVY8NkdOkcXyg-MyeE")
...
async def dynamic_login_steps(_, message: Message):
    ...
    if user_id not in login_state or not message.text:
        return
...
───────────────────•"""
        ...
        try:
            await message.reply_text(
                "⚠️ **Start panel load nahi ho paya.**\n"
                f"`{str(e)}`"
            )
        except Exception:
            pass
...
"""
            ...
            # Logger fail hone par bot crash NAHI hoga
            print(
    ...
    # =====================================================
    # KEEP BOT ALIVE ON THE SAME EVENT LOOP
    # Pyrogram idle() removed intentionally.
    # This fixes:
